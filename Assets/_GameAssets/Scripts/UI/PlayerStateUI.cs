...
public class PlayerStateUI : MonoBehaviour
{
    ...
    [SerializeField] private Sprite _playerWalkingActivateSprite;
    [SerializeField] private Sprite _playerWalkingPassiveSprite;
    [SerializeField] private Sprite _playerSlidingActivateSprite;
    ...
    private void Start()
    {
        ...
        SetStateUserInterfaces(_playerWalkingActivateSprite, _playerSlidingPassiveSprite, _playerWalkingTransform, _playerSlidingTransform);
    }
    ...
    private void PlayerController_OnPlayerStateChanged(PlayerState playerState)
    {
        switch (playerState)
        {
            ...
            case PlayerState.Slide:
                ...
                SetStateUserInterfaces(_playerWalkingPassiveSprite, _playerSlidingActivateSprite, _playerSlidingTransform, _playerWalkingTransform);
                break;
    ...
    private IEnumerator SetBoosterInterfaces(RectTransform activeTransform,Image boosterImage,Image wheatImage,Sprite activeSprite,Sprite passiveSprite,Sprite activeWheatSprite,Sprite passiveWheatSprite,float duration)    
    {
    ...
    {
        StartCoroutine(SetBoosterInterfaces(activeTransform,boosterImage,wheatImage,activeSprite,passiveSprite,activeWheatSprite,passiveWheatSprite,duration));
    }
}
